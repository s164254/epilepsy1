% plot_ecg_rr_window performs a RQS detection using function specified in qrs_func_name,
% calculates RR intervals from QRS detected indices
% and plots the ECG signal with QRS detections, plots RR intervals and plots CSI
%
params = load_params();
