...
%Thus, by using order 4, it is actually 8. However, using filtfilt might double the order again,
%so that the true order is 16. Ask if this is the case. The cut-off frequencies
